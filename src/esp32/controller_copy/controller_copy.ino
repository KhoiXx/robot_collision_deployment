...
MotorController leftWheel(14, 27, 16, 17, 4, 15000, 0.0342, 10.0, 5.2, 0.01, pidSampleTime, 1.15, DIRECT);
MotorController rightWheel(18, 19, 21, 22, 23, 15000, 0.0342, 10.0, 5.2, 0.01, pidSampleTime, 1.15, REVERSE);
