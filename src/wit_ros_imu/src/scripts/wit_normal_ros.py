...
def handleSerialData(raw_data, frame_id):
    ...
    if key < 11:
        ...
        if angle_flag:                
            ...
            adjusted_quaternion = quaternion_multiply(rotation_quaternion, qua)
            imu_msg.orientation.x = adjusted_quaternion[0]
            imu_msg.orientation.y = adjusted_quaternion[1]
            imu_msg.orientation.z = adjusted_quaternion[2]
            imu_msg.orientation.w = adjusted_quaternion[3]
