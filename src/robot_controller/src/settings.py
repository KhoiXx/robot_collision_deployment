...
NUM_BEAMS = int(os.getenv('NUM_BEAMS', "226"))
ACT_SIZE = int(os.getenv('ACT_SIZE', "24"))
LEARNING_RATE = float(os.getenv('LEARNING_RATE', "5e-5"))
COEFF_ENTROPY = float(os.getenv('COEFF_ENTROPY', "5e-4"))
COEFF_VALUE_LOSS = float(os.getenv('COEFF_VALUE_LOSS', "20"))
...
LASER_RANGE = float(os.getenv('LASER_RANGE', "4.5"))
...
ACTION_BOUND = ast.literal_eval(os.getenv('ACTION_BOUND', "[[0, -2], [1.1, 2]]"))
