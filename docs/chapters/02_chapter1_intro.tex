...
\begin{enumerate}
    ...
    \item Đạt tỷ lệ thành công tối thiểu 75%.
    ...
    \item Triển khai và kiểm nghiệm thực tế mô hình trên 2 robot trong thực nghiệm.
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Số lượng:} 44-58 robots hoạt động đồng thời trong mô phỏng; 2 robot trong thực nghiệm
\end{itemize}
